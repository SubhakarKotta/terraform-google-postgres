...
output "dependency_id" {
  value = "${join("/", list(google_sql_database_instance.master.name,google_sql_user.user.name,google_sql_database.initdatabase.name,google_sql_database_instance.master.private_ip_address,google_sql_database_instance.master.ip_address.0.ip_address))}"
}
